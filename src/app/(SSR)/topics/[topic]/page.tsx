...
export default async function page({params: { topic } }: PageProps) {
  ...
  return (
    <div>
     <Alert>
        This page uses <strong>generateStaticProps</strong> to render and cache static pages at build time, even though the url has a dynamic parameter. Pages that are not included in generateStaticParams will be fetched & rendered on first access and then <strong>cached
